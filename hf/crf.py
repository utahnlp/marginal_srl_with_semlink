...
class ConditionalRandomField(torch.nn.Module):
    ...
    def _input_likelihood(self, logits: torch.Tensor, mask: torch.Tensor) -> torch.Tensor:
        ...
        transitions = self.transitions.to(logits.device)
        start_transitions = self.start_transitions.to(logits.device)
        end_transitions = self.end_transitions.to(logits.device)
